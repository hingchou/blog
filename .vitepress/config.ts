...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright:
        '<a class="footer-cc-link" target="_blank" href="https://creativecommons.org/licenses/by-nc-sa/4.0/"> 4.0</a> © 2022-PRESENT arnoldxiao <br/> <a class="footer-cc-link" target="_blank" href="https://beian.miit.gov.cn/"></a>',
    },
    search: {
      provider: 'local',
      options: {
